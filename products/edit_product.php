                            ...
                            <tbody>
                                <?php if (!empty($variants)): ?>
                                    ...
                                    <tr>
                                        ...
                                        <td><input type="number" class="form-control form-control-sm border-0 bg-light" name="variant_cost[]" step="0.01" value="<?php echo $variant['cost_price']; ?>" style="width: 80px;"></td>
