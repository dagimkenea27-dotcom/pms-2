...
if ($_SERVER['REQUEST_METHOD'] === 'POST') {
    if (!isset($_POST['csrf_token']) || !Auth::validateCSRF($_POST['csrf_token'])) {
        ...
        try {
            ...
            if (empty($products_input)) throw new Exception("At least one product must be added.");
    ...
    <div class="row">
        ...
        <div class="col-lg-12">
            ...
            <div class="card shadow mb-4">
                ...
                <div class="card-body">
                    <textarea name="notes" class="form-control" rows="3" placeholder="Any special instructions for the whole order..."></textarea>
    ...
    <div class="product-block border rounded p-3 mb-4 bg-light" data-index="{PRODUCT_INDEX}">
        ...
        <div class="row mb-3">
            <div class="col-md-8">
                ...
                <input type="text" name="products[{PRODUCT_INDEX}][name]" class="form-control" placeholder="e.g. Shein Blue Dress" required>
            </div>
            <div class="col-md-4">
...
<template id="variationTemplate">
    <tr class="variation-row">
        <td><input type="text" name="products[{PRODUCT_INDEX}][variations][{VAR_INDEX}][color]" class="form-control form-control-sm" placeholder="e.g. Blue"></td>
        <td><input type="text" name="products[{PRODUCT_INDEX}][variations][{VAR_INDEX}][size]" class="form-control form-control-sm" placeholder="e.g. XL"></td>
        <td><input type="number" name="products[{PRODUCT_INDEX}][variations][{VAR_INDEX}][quantity]" class="form-control form-control-sm" value="1" min="1"></td>
        <td><input type="text" name="products[{PRODUCT_INDEX}][variations][{VAR_INDEX}][options]" class="form-control form-control-sm" placeholder="e.g. Gift wrap"></td>
